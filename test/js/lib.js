...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.carousel = function () {
  for (let i = 0; i < this.length; i++) {
    const slides = this[i].querySelectorAll('.carousel>div'); //? Create slides wrapper
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])('.carousel-indicators li').eq(0).addClass('active');
    const dots = this[i].querySelectorAll('.carousel-indicators li');
    const slideId = this[i].getAttribute('id');
    Object(_core__WEBPACK_IMPORTED_MODULE_1__["default"])(`#${slideId} .carousel-indicators li`).click(e => {
    ...
    this[i].insertAdjacentElement('beforeend', arrowNext); //? Create arrow prev
    ...
    this[i].insertAdjacentElement('beforeend', arrowPrev); //? Show next slide
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.modal = function (created) {
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(e => {
      e.preventDefault();
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(target).fadeIn(500, 'flex');
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].getAttribute('data-target')).fadeIn(500, 'flex');
  }
};
...
1; // Метод удаления классов. На вход принимает список классов
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype._fadeOut = function (dur, fin, i) {
